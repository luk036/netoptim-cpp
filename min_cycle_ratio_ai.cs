...
public class MinCycleRatioSolver<V, R> where R : struct, IComparable<R>, IEquatable<R>, IConvertible
{
...
public class CycleRatioAPI<V, R> where R : struct, IComparable<R>, IEquatable<R>, IConvertible
{
    private readonly Dictionary<V, Dictionary<V, dynamic>> gra;
...
{
    public static void SetDefault<V, D>(this Dictionary<V, Dictionary<V, dynamic>> gra, string weight, D value) where D : struct, IComparable<D>, IEquatable<D>, IConvertible
    {
