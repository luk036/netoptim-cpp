...
class NegCycleFinder {
    ...
    public:
        ...
        bool relax(unordered_map<int, int>& dist, function<int(pair<int, int>)> get_weight) {
            bool changed = false;
            for (auto it = gra.begin(); it != gra.end(); it++) {
                int u = it->first;
        ...
        vector<pair<int, int>> find_neg_cycle(unordered_map<int, int>& dist, function<int(pair<int, int>)> get_weight) {
            pred.clear();
            vector<pair<int, int>> cycle;
            bool found = false;
...
int main() {
    ...
    vector<pair<int, int>> cycle = ncf.find_neg_cycle(dist, [](pair<int, int> p) {return p.second;});
    if (cycle.empty()) {
