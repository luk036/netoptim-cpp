...
- Replace all occurrences of "NetOptimCpp" in the relevant CMakeLists.txt with the name of your project
  - Capitalization matters here: `NetOptimCpp` means the name of the project, while `netoptim` is used in file names.
...
./build/standalone/NetOptimCpp --help
```
